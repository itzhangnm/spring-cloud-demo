package com.zb.consumer.feign.hystrix.service;
 ...
 * @author zb
 */
@FeignClient(name = "cloud-provider-user",fallback = UserFeignHystrixClient.HystrixClientFallback.class)
public interface UserFeignHystrixClient {
    ...
    static class HystrixClientFallback implements UserFeignHystrixClient{
        ...
        public User findByIdFeign(Long id) {
            HystrixClientFallback.LOGGER.info("异常发⽣，进入fallback方法，接收的参数：id = {}", id);
            User user = new User();
            user.setId(-1L);
